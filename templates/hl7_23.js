...
const templates = {
  ...
  gt1_template: function gt1_template() {
    this.set_id = components => datatypes.parse_SI(components[1]);
    this.guarantor_number = components => datatypes.parse_CX(components[2]);
    this.guarantor_name = components => datatypes.parse_XPN(components[3]);
    this.guarantor_spouse_name = components => datatypes.parse_XPN(components[4]);
    this.guarantor_address = components => datatypes.parse_XAD(components[5]);
    this.guarantor_home_phone_ = components => datatypes.parse_XTN(components[6]);
    this.guarantor_business_phone = components => datatypes.parse_XTN(components[7]);
    this.guarantor_dob = components => datatypes.parse_TS(components[8]);
    this.guarantor_sex = components => datatypes.parse_IS(components[9]);
    this.guarantor_type = components => datatypes.parse_IS(components[10]);
    this.guarantor_relationship = components => datatypes.parse_IS(components[11]);
    this.guarantor_ssn = components => datatypes.parse_ST(components[12]);
    this.guarantor_begin_date = components => datatypes.parse_DT(components[13]);
    this.guarantor_end_date = components => datatypes.parse_DT(components[14]);
    this.guarantor_priority = components => datatypes.parse_NM(components[15]);
    this.guarantor_employer_name = components => datatypes.parse_XPN(components[16]);
    this.guarantor_employer_address = components => datatypes.parse_XAD(components[17]);
    this.guarantor_employ_phone_number = components => datatypes.parse_XTN(components[18]);
    this.guarantor_employee_id_number = components => datatypes.parse_CX(components[19]);
    this.guarantor_employment_status = components => datatypes.parse_IS(components[20]);
    this.guarantor_organization = components => datatypes.parse_XON(components[21]);
    this.guarantor_billing_hold_flag = components => datatypes.parse_ID(components[22]);
    this.guarantor_credit_rating_code = components => datatypes.parse_CE(components[23]);
    this.guarantor_death_date_and_time = components => datatypes.parse_TS(components[24]);
    this.guarantor_death_flag = components => datatypes.parse_ID(components[25]);
    this.guarantor_charge_adjustment_code = components => datatypes.parse_CE(components[26]);
    this.guarantor_household_annual_income = components => datatypes.parse_CP(components[27]);
    this.guarantor_household_size = components => datatypes.parse_NM(components[28]);
    this.guarantor_employer_id_number = components => datatypes.parse_CX(components[29]);
    this.guarantor_marital_status_code = components => datatypes.parse_IS(components[30]);
    this.guarantor_hire_effective_date = components => datatypes.parse_DT(components[31]);
    ...
    this.guarantor_employers_organization_name = components => datatypes.parse_XON(components[51]);
    this.handicap = components => datatypes.parse_IS(components[52]);
    this.job_status = components => datatypes.parse_IS(components[53]);
    this.guarantor_financial_class = components => datatypes.parse_FC(components[54]);
    this.guarantor_race = components => datatypes.parse_IS(components[55]);
  }
};
